...
export const ru: Translations = {
  ...
  settings_description:    'Ключи хранятся в Rust-бэкенде и никогда не попадают в интерфейс.',
  ...
  settings_provider_label:   'AI-провайдер',
  settings_provider_hint:    'Выберите модель для исследования',
  settings_model_label:      'Модель',
  settings_model_hint:       'Оставьте по умолчанию или выберите другую',
  settings_apikey_label:     'API-ключ',
  settings_apikey_saved:     'Ключ сохранён — оставьте пустым, чтобы не менять',
  settings_ollama_url_label: 'URL сервера Ollama',
  settings_ollama_hint:      'Локальный сервер — ключ не нужен',
