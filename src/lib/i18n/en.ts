...
export const en: Translations = {
  ...
  settings_description:    'Keys are stored in the Rust backend and never exposed to the UI.',
  ...
  settings_provider_hint:    'Choose which model powers exploration',
  settings_model_label:      'Model',
  settings_model_hint:       'Leave default or pick another',
  settings_apikey_label:     'API Key',
  settings_apikey_saved:     'Key saved — leave blank to keep it',
  settings_ollama_url_label: 'Ollama server URL',
  settings_ollama_hint:      'Local server — no API key needed',
